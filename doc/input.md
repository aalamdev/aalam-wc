...
|-------------|--------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `label`     | String<br>Default: `Label`                       | The label for the text field/input box |
...
| `color`     | String<br>Default: `currentColor`                | The color to be used for the outline and label text |
| `disabled`  | Boolean                                          | When present, it means the input box will be in disabled state. |
| `prefix`    | String<br>Default: `""`                          | A prefix text  |
| `suffix`    | String<br>Default: `""`                          | A suffix text  |
